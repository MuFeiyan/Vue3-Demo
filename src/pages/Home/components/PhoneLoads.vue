  ...
  <div class="flex flex-col items-center">
    ...
    <div class="relative w-40 h-40">
      ...
      <div class="absolute inset-0 z-10 flex flex-col items-center justify-center">
        <el-icon :size="40" color="#34d399"><Collection /></el-icon>
        <div class="text-2xl font-bold text-gray-800">3,271</div>
    ...
    <div class="flex justify-between w-full mt-4 text-sm text-gray-600 px-2">
      <div class="flex items-center space-x-1">
        ...
        <span>New:</span>
        <span class="font-medium text-gray-800">2.6k</span>
      </div>
      <div class="flex items-center space-x-1">
        <span class="w-3 h-3 rounded-full bg-gray-300 inline-block"></span>
        <span>Returning:</span>
        <span class="font-medium text-gray-800">677</span>
      </div>
    </div>
  </div>
</template>
